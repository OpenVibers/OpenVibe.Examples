...
const SDK = 'https://codeload.github.com/OpenVibers/OpenVibe.SDK/tar.gz/refs/tags/v0.3.1';
...
for (const name of EXPECTED) {
    ...
    for (const [dep, spec] of Object.entries({ ...pkg.dependencies, ...pkg.devDependencies })) {
        ...
        if (dep === 'openvibe-sdk') assert.equal(spec, SDK, `${name}: openvibe-sdk pinned to v0.3.1`);
    }
